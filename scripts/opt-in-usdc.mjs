...
// Usage: node scripts/opt-in-usdc.mjs
...
const USDC_ASA_ID = 10458941n; // TestNet USDC
const ALGOD_URL = "https://testnet-api.algonode.cloud";
const ALGOD_TOKEN = "";

const algodClient = new algosdk.Algodv2(ALGOD_TOKEN, ALGOD_URL, "");

async function optIn(label, address, mnemonic) {
  ...
  console.log(`[opt-in] ${label} confirmed at round ${result["confirmed-round"]}`);
  return txid;
}
